...
// Class managing a collection of Integer arrays, allowing for thread safe removal
// and insertion of arrays in the collection
public class SynchronizedCollection {
	private final LinkedList<Integer[]> sharedCollection = new LinkedList<Integer[]>();
	private int numberOfArrays;
	
	// constructor
	public SynchronizedCollection(Integer[] array) {
	...
	public synchronized boolean checkAndTakeTwoElements(LinkedList<Integer[]> arraysToMerge)
	...
	public synchronized void insertElement(Integer[] merged) {
